...
새 기능은 [작업 흐름](architecture.ko.md)에 따라 기획 → Figma MCP로 Figma에 직접 디자인 → 승인된 파일 기반 Design System → 토큰 매칭 → 네이티브 앱 개발 → GraphQL 계약 생성 → 백엔드 개발 순서로 진행한다. 승인된 산출물·기존 계약은 재사용하고 한정된 수정은 요청된 단계부터 진행한다.
...
| 디자인: Figma 디자인·Design System·토큰 매칭·시각 명세 인계 | [디자인 규칙](../app/design/AGENTS.ko.md), [design-app](../.agents/skills/design-app/SKILL.ko.md) |
