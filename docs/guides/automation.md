...
| `design` | Optional ui-ux-pro-max direction seed, proof screen then full design in Figma via Figma MCP, Design System from the approved file, token matching before app development, visual review; records in `app/design/history/` | [design-app](../../.agents/skills/design-app/SKILL.md) |
