...
| `design` | Direct Figma design via Figma MCP tools, optional ui-ux-pro-max direction seed, Design System from the approved file, token matching before app development, visual review | [design-app](../../.agents/skills/design-app/SKILL.md) |
