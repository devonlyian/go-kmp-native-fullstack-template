...
| `design` | ui-ux-pro-max 방향 시드(선택)·Figma MCP로 시제품 화면 후 전체 디자인·승인된 파일 기반 Design System·앱 개발 전 토큰 매칭·시각 검토. 기록은 `app/design/history/` | [design-app](../../.agents/skills/design-app/SKILL.ko.md) |
